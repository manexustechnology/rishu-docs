...
const config: Config = {
  title: 'Rishu',
  tagline: 'Easy invest with Rishu',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/rishu-foundation',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Rishu. Built with Docusaurus.`,
    },
    prism: {
